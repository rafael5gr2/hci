...
Η άσκηση που επέλεξα (https://pibook.epidro.me/remix/button/) ζητούσε να προσθέσουμε μία λειτουργία της επιλογής μας όταν πατηθεί το κουμπί.
